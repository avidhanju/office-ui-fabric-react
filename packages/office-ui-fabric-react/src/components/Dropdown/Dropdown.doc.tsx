...
import { DropdownFilterExample } from './examples/Dropdown.Filter.Example';
...
const DropdownFilterExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Dropdown/examples/Dropdown.Filter.Example.tsx') as string;
...
export const DropdownPageProps: IDocPageProps = {
  ...
  examples: [
    ...
    {
      title: 'Dropdown with filter box',
      code: DropdownFilterExampleCode,
      view: <DropdownFilterExample />
    }
  ],
